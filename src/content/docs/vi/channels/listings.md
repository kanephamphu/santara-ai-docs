...
thấy danh sách đầy đủ listing của nó, mỗi cái quản lý riêng.

## Trang kết nối

Mỗi tài khoản đã kết nối có trang riêng hiển thị:
...
Mở kết nối, bấm **Tìm listing trên tài khoản này**, và những listing chưa nhập sẽ hiện ra. Chọn nơi
đến cho từng cái như lần nhập đầu. Listing mới bạn tạo trên kênh sau này cũng xuất hiện ở đây.

## Thêm tài khoản khác

**Kết nối tài khoản khác** trên cùng một kênh. Thường gặp với đơn vị quản lý giữ listing dưới nhiều
tài khoản Airbnb. Mỗi kết nối độc lập với nhau.
...
Với **Booking.com**, bất động sản mà một khách sạn liên kết tới *có thể* đổi tại chỗ — **Đổi bất động
sản**. Đặt phòng và tin nhắn trong tương lai về bất động sản mới; những gì đã nhập vẫn nguyên chỗ.
...
**Ngắt kết nối** dừng đồng bộ và xóa mọi thứ đã nhập từ tài khoản đó. Phía kênh vẫn nguyên. Kết nối
lại cùng tài khoản sau này là bình thường.

Cố kết nối một tài khoản đã kết nối sẽ nhận *"Tài khoản Airbnb này đã được kết nối"* — hãy ngắt kết
nối cũ trước.
