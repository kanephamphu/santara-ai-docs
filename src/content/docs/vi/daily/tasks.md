---
title: Công việc — dọn phòng và bảo trì
description: Turnover tự tạo, nhân viên dọn phòng chỉ thấy việc của mình, và ticket cho mọi thứ hỏng hóc.
sidebar:
  order: 3
---
...
giờ trả phòng, lượt đến kế tiếp, và nhân viên được phân công.

**Công việc turnover được tạo tự động vào đêm trước ngày trả phòng.** Không ai phải nhớ tạo nó, và nó
chỉ được tạo cho đúng ngày đó — bảng này cuộn theo vài ngày, không phải cả năm hàng đã dựng sẵn.

Với mỗi công việc bạn có thể:

- **Phân công nhân viên** — hoặc để phân công mặc định của phòng làm việc đó.
- **Đánh dấu hoàn tất**, kèm ảnh làm bằng chứng nếu muốn.
- **Bỏ qua**, kèm lý do, khi khách ở tiếp hoặc phòng không được dùng.

### Nhân viên mặc định theo phòng
...
### Nhân viên dọn phòng thấy gì

Thành viên có vai trò dọn phòng thấy **những ca được phân công cho họ**, và đủ thông tin để tìm ra bất
động sản. Không phải đặt phòng của bạn, không phải doanh thu của bạn, không phải mã cửa của các tòa
khác. Xem [Đội ngũ và vai trò](/vi/setup/team/).
...
Bên cạnh công việc có **trò chuyện nội bộ** cho những người vận hành bất động sản — cuộc trao đổi mà
bình thường diễn ra trong một nhóm WhatsApp không thể tìm lại sau này. Tách khỏi tin nhắn khách, và
khách không thấy được.
